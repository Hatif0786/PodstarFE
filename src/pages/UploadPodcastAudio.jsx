...
const UploadPodcastAudio = ({ setMenuOpened, menuOpened, setUserlogged, logout }) => {
  ...
  return (
    <>
      ...
      {!loader && (
        <>
          <div className="file-upload-wrapper" style={{ textAlign: "center", marginTop: "8%" }}>
            {err && (
              <div className="container">
                <h1 style={{ color: "red", margin: "25px" }}>
                  <b>{err}</b>
                </h1>
              </div>
            )}
          ...
          {file && (
            <div style={{ textAlign: "center" }}>
              ...
              <button className="button" onClick={handleFileUpload} style={{ marginBottom: "20%" }}>
